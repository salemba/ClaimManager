...
namespace ClaimManager.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260521132926_UpdateSeedData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClaimManager.Domain.Audit.IntegrationHealthIncident", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_integration_health_incidents");

                    b.HasIndex("BoundaryName", "StartedAtUtc")
                        .HasDatabaseName("ix_integration_health_incidents_boundary_name_started_at_utc");

                    b.ToTable("integration_health_incidents", (string)null);
                });

            modelBuilder.Entity("ClaimManager.Domain.ClaimantCommunication.ClaimCommunication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ClaimManager.Domain.Claims.Claim", b =>
                {
                    ...
                    b.Property<string>("ActiveDataIntegrityIssuesJson")
                        .HasColumnType("jsonb")
                    ...
                    b.Property<DateTime?>("DocumentSyncedAtUtc")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<string>("LastReconciliationDetailsJson")
                        .HasColumnType("jsonb")
                    ...
                    b.Property<DateTimeOffset?>("PaymentSettledAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<DateTime?>("PaymentSyncedAtUtc")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<DateOnly?>("PolicyExpirationDate")
                        .HasColumnType("date")
                    ...
                    b.Property<DateTime?>("PolicySyncedAtUtc")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedByUserId = "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa",
                            HasDataIntegrityWarning = false,
                            LossDateUtc = new DateTime(2026, 5, 6, 0, 0, 0, 0, DateTimeKind.Utc),
                            LossDescription = "Two-car collision at intersection.",
                            LossType = "Collision",
                            OwnedByUserId = "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa",
                        ...
                        new
                        {
                            ...
                            CreatedByUserId = "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa",
                            HasDataIntegrityWarning = false,
                            LossDateUtc = new DateTime(2026, 4, 21, 0, 0, 0, 0, DateTimeKind.Utc),
                            LossDescription = "Vehicle stolen from driveway.",
                            LossType = "Theft",
                            OwnedByUserId = "bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb",
            ...
            modelBuilder.Entity("ClaimManager.Infrastructure.Identity.ClaimManagerUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "user-dddddddd-dddd-dddd-dddd-dddddddddddd",
                            CreatedAtUtc = new DateTime(2026, 5, 11, 0, 0, 0, 0, DateTimeKind.Utc),
                            Email = "supervisor@claimmanager.local",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "SUPERVISOR@CLAIMMANAGER.LOCAL",
                            NormalizedUserName = "SUPERVISOR@CLAIMMANAGER.LOCAL",
                            PasswordHash = "AQAAAAIAAYagAAAAEOUuFEwF4KN1J99pZOcA/NhSulx4W7w+YJV/mk8bRg6lI2sxfCR7TK2uiq/i95CuMA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "security-dddddddd-dddd-dddd-dddd-dddddddddddd",
                            TwoFactorEnabled = false,
                            UserName = "supervisor@claimmanager.local"
                        });
                });
